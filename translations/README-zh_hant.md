...
- [目錄](#目錄)
    ...
    - [資料庫](#資料庫)
        - [各種雲端服務資料庫的一個方便速查表](#各種雲端服務資料庫的一個方便速查表)
...
為您的專案選擇合適的資料庫是一項複雜的任務。許多資料庫選項各自適用於不同的使用情境，這很容易導致決策疲勞。

我們希望這份速查表能提供高層次的指引，幫助您找到符合專案需求的合適服務，並避免潛在的陷阱。

注意：Google 對其資料庫使用情境的文件有限。儘管我們盡力查看了可用的資料並得出了最佳選擇，但某些條目可能需要更準確的資料。
